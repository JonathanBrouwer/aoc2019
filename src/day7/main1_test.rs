#[cfg(test)]
mod test {
    use crate::day7::main1::{run_parse,run};
    use crate::day7::main1::try_settings;
    ...
    fn test_part1_1() {
        ...
        let outputs = run_parse(input, vec!(17));
    ...
    fn test_part2_2() {
        let input = "3,9,8,9,10,9,4,9,99,-1,8";
        let outputs = run_parse(input, vec!(8));
    ...
    fn test_part2_4() {
        let input = "3,9,7,9,10,9,4,9,99,-1,8";
        let outputs = run_parse(input, vec!(7));
        assert_eq!(outputs, vec!(1));
    }
    ...
    fn test_part2_9() {
        let input = "3,3,1107,-1,8,3,4,3,99";
        let outputs = run_parse(input, vec!(-99));
        assert_eq!(outputs, vec!(1));
    }
    ...
    fn test_part2_10() {
        ...
        let outputs = run_parse(input, vec!(0));
        assert_eq!(outputs, vec!(0));
    }
    ...
    fn test_part2_11() {
        let input = "3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9";
        let outputs = run_parse(input, vec!(1));
        assert_eq!(outputs, vec!(1));
    }
    ...
    fn test_part2_16() {
        let input = "3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99";
        let outputs = run_parse(input, vec!(9));
