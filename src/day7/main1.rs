            ...
            for i3 in 0..=4 {
                for i4 in 0..=4 {
                    for i5 in 0..=4 {
                        ...
                        //Run output
                        let output1 = run_parse(program, vec!(i1, 0));
                        let output2 =run_parse(program, vec!(i2, output1[0]));
                        let output3 =run_parse(program, vec!(i3, output2[0]));
                        let output4 =run_parse(program, vec!(i4, output3[0]));
                        let output5 =run_parse(program, vec!(i5, output4[0]));
                        max = max.max(output5[0]);
                    }
                }
            }
        }
...
pub fn run_parse(program: &str, inputs: Vec<i32>) -> Vec<i32> {
